...
### Что было сделано и где находится
1. Реализован новый раздел базы данных tracks_traffic
2. Реализован новый раздел базы данных private_tg
3. Реализованы новые функции обращения к БД (backend) - src/Database/trucks_traffic
4. Реализованы новые API-методы (backend) - src/API/tracks_traffic_analytics и api_main.py, src/API/private_tg
5. Доработан старый и реализован новый функционал сайта (frontend) - src/smolensk-codd
6. Обновление функционала было загружено на сервер через Docker
7. Пересмотрен и минимально обновлен дизайн сайта и лого

### Работоспособность сценариев и их завершенность
1. Совместное движение - реализован полностью, работает на сайте
2. Совместное движение с фильтрами - реализован полностью, работает на сайте
3. Кластеризация по 1 периоду - реализован полностью, работает на сайте
4. Кластеризация по 2 периодам - реализован полностью, работает на сайте
5. Работа нового закрытого телеграмм бота - реализован частично, не готов к продакшену, наработки находятся src/private_tg
...
| Серикова Анастасия | [moreiwi](https://github.com/moreiwi "Серикова Анастасия") | Frontend-разработчик | 	React, Figma |
